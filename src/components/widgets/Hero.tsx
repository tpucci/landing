...
export default component$(() => {
  return (
    <section class="bg-gradient-to-b md:bg-gradient-to-r from-sky-100 via-purple-50/10 to-white/20 dark:from-slate-900 dark:via-purple-900/10 dark:to-sky-900/20 mt-[-72px]">
